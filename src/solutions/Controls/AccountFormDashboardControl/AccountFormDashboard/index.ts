...
export class AccountFormDashboard implements ComponentFramework.StandardControl<IInputs, IOutputs> {
  ...
  public init(
    ...
    this.currentValue = context.parameters.controlValue.raw ?? "";
  ...
  public getOutputs(): IOutputs {
    return {
      controlValue: this.currentValue,
    };
  }
